...
class Form::AdminSettings
  ...
  # Hometown: Move local_feed after about page, to display the about page first.
  LANDING_PAGE = %w(trends overview about local_feed).freeze
